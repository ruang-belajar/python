...
Kita bisa mengakses elemen pada list dengan cara sebagai berikut:
...
Anda dapat memperbarui/update satu atau beberapa nilai di dalam list dengan memberikan potongan di sisi kiri operator penugasan, dan Anda dapat menambahkan nilai ke dalam list dengan metode append (). Sebagai contoh :
